...
### Arquitectura de evaluación de tres capas

En la ingeniería práctica de IA, los sistemas de evaluación suelen adoptar una**layered architecture**El diseño de la API permite filtrar las salidas desde abajo hacia arriba, lo que garantiza el rendimiento y la velocidad de evaluación, controlando los costes de la API y alineando el juicio final con los expertos humanos.
...
#### Capa 1: Basado en reglas y determinista (basado en reglas)  Debe fallar rápidamente

Antes de llamar a jueces de LLM caros y lentos, utilice código determinista para filtrar errores simples / obvios primero.

- **Core Metrics for Implementation**¿Qué es esto ?
  - **JSON-Schema Validation**Si su empresa requiere un estricto cumplimiento de un formato JSON específico (por ejemplo, etiquetado, extracción de metadatos), analice y valide directamente usando código. Si el análisis falla, califique cero inmediatamente y omita las evaluaciones posteriores de LLM-as-a-judge.
  - **Regex & Sensitive Word Interception**: Compruebe si la salida contiene cargadores de lugar (como `{{missing_value}}`), se filtra en el sistema de respuesta o contiene caracteres ilegales/sensibles.
  - **Length & Type Constraints**: Por ejemplo, si un resumen de una película está limitado a 100 palabras, marque que no cumple si excede de 150 palabras.
- **Best Practice**En el caso de las máquinas de control de velocidad, el sistema de control de velocidad de la máquina de control de velocidad de la máquina de control de velocidad de la máquina de control de velocidad de la máquina de control de velocidad de la máquina de control de velocidad de la máquina de control de velocidad de la máquina de control de velocidad de la máquina de control de velocidad de la máquina de control de velocidad de la máquina de control de velocidad de la máquina de control de velocidad de la máquina de control de velocidad de la máquina de control de velocidad de la máquina de control de velocidad de la máquina de control de velocidad de la máquina de control de velocidad de la máquina de control de velocidad de la máquina de control de velocidad de la máquina de control de velocidad de la máquina de control de la máquina de control de velocidad de la máquina de control de control de velocidad de velocidad de la máquina de control de control de la máquina de control de control de velocidad de velocidad de la máquina de control de control de la máquina de control de control de la máquina de control de control de control de la máquina de control de control de control de la máquina de control de control de control de control de la máquina de control de control de control de control de control de la máquina de control de control de control de control de control de la máquina de control de control de control de control de control de control de la máquina de control de control de control de control de control de control de control de control de control de control de control de control de la máquina de control de control de control de control de control de control de control de control de control de control de control de la máquina de la máquina de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de control de cuento de control de control de control de control de control de cuento de cuento de control de cuento de control de cuento de control de cuento de control de control de

#### Layer 2: LLM-as-a-Judge  El caballo de trabajo de la industria actual

Utilice un modelo más capaz (se recomienda como jueces el Claudio 3.5 Sonnet o GPT-4o) para evaluar el modelo objetivo.

- **Three Main Evolution Directions**¿Qué es esto ?
  1. **G-Eval (Rubric-based Natural Language Scoring)**Proporcionar al juez una rúbrica extremadamente detallada y obligarlo a usarla.**Chain-of-Thought (CoT)**(escribe las razones primero, marca al final).
  2. **QAG Mode (Question-Answer Generation Loop)**En lugar de obtener puntuaciones directas, haga preguntas binarias al juez: "¿La respuesta se basa completamente en documentos de referencia? (Sí/No) ", "La respuesta aborda la pregunta del usuario? (Sí/No)". Convertir preguntas subjetivas en tareas objetivas de opción múltiple/binarias da resultados muy estables.
  3. **Pairwise Preference (Head-to-Head)**: Entrega las salidas del antiguo y del nuevo aviso lado a lado al juez (anonimado para pruebas a ciegas) y deja que el juez elija cuál es mejor (A gana / B gana / Tie).
- **Preventing Judge Biases**¿Qué es esto ?
  > ¿Qué es eso?
  > **The Three Sins of LLM Judges:**
  > - **Verbosity Bias**El juez tiende a favorecer respuestas más largas y con más palabras.
  > - **Position Bias**En las pruebas a ciegas, el juez está sesgado a la elección de la opción A (locado primero).
  > - **Self-Enhancement Bias**: Los modelos GPT prefieren las salidas de estilo GPT, mientras que los modelos Claude prefieren las salidas de estilo Claude.
  
  **Countermeasures**¿Qué es esto ?
  - En el aviso, diga explícitamente: "La concisión es una medida clave para evaluar.
  - Para las comparaciones en pareja, intercambiar las posiciones de A y B y volver a ejecutar la evaluación, tomando la puntuación media.
  - Elige modelos de jueces de una familia diferente al modelo que se evalúa (por ejemplo, use Claude para evaluar GPT).
  - Utilice la clasificación binaria (Pass/Fail, Yes/No) en lugar de una escala de 1-5 Likert cuando sea posible.

#### Capas 3: Evaluación humana  Anclar de calibración

La evaluación humana no está destinada a calificar miles de puntos de datos diarios que quemarían a cualquier equipo.**calibrating the judge model (Aligning the Judge)**¿ Qué ?

- **Core Implementation Practices**¿Qué es esto ?
  1. **Blind Testing (Arena Mode)**: Seleccione 3050 casos difíciles y ambigüos de los flujos de negocio principales y haga que expertos humanos los califiquen ciegamente.
  2. **Consistency Check**: Computa métricas de acuerdo (como la Kappa de Cohen) entre las calificaciones humanas y las calificaciones de juez de LLM.
- **Best Practice**¿Qué es esto ?
  - Si la coherencia entre el juez de LLM y los expertos humanos alcanza el 80%85%+, el juez se considera confiable en ingeniería.
  - Cuando se produzca una desalineamiento, inspeccione el "razón" proporcionado por el juez y perfeccione el sistema del modelo del juez en consecuencia.
...
### Datos de Eval: Construcción y mejores prácticas

La calidad de su conjunto de datos de evaluación determina directamente el límite máximo de los resultados de su evaluación.
...
La creación de un conjunto de datos de evaluación de alta calidad requiere medidas sistemáticas y el cumplimiento de las mejores prácticas.

#### 1. Cuatro pasos fundamentales para construir un conjunto de datos de evaluación

1. **Define Evaluation Goals & Scenarios (Defining Schema)**
   No trate de crear un conjunto de datos "de un tamaño para todos".
   - **General Capabilities**: Razonamiento, codificación, juego de roles, resumen de texto, etc.
   - **Vertical Business**: Aparecimiento de películas, extracción automática de metadatos, corrección de errores ASR, comprensión de videos largos, etc.
   - **Guardrail Evaluation**: Seguridad, tasa de alucinación, robustez (sensibilidad a los errores de tipografía y ruido).

2. **Determine Data Format (Data Format)**
   JSONL es el formato más utilizado en la industria. Cada línea es un objeto JSON independiente, que es conveniente para la transmisión. Dependiendo del método de evaluación, el formato de datos generalmente se estructura como:
   - **Objective Evaluation (with standard reference answers)**¿Qué es esto ?
     ```json
     {"question": "Who directed The Matrix?", "answer": "The Wachowskis", "category": "movie_trivia"}
     ```
   - **Subjective/Open-ended Evaluation (based on LLM-as-a-Judge or human evaluation)**¿Qué es esto ?
     ```json
...
3. **Data Sourcing & Collection (Data Sourcing)**
   - **Production Logs (Highly Recommended)**: Muestra de tráfico de producción real (User Prompts) y anónima. Esto representa la "prueba real" más realista para su negocio.
   - **Synthetic Data**: Utilice los modelos más capaces (por ejemplo, GPT-4o o Claude 3.5 Sonnet) para generar en lotes Prompts de acuerdo con un esquema específico, luego filtrarlos a través de revisión humana o heurísticas.
   - **Adoption/Modification of Public Benchmarks**: Adaptar los puntos de referencia estándar como MMLU, GSM8K o MATH para adaptarse a sus necesidades específicas de negocio.

4. **Cleaning & Validation (Data Curation)**
   - **Deduplication**: Utilice algoritmos de similitud semántica o coincidencia exacta para evitar que aparezcan repetidas veces Prompts casi idénticos.
   - **Difficulty Grading**: Categorizar el conjunto de datos en fácil / mediano / difícil para diferenciar claramente los niveles de rendimiento entre los diferentes modelos.
   - **Rule-based Filtering**: Elimine errores gramaticales, frases ambiguas, indicaciones mal definidas o información sensible.

#### 2. Las mejores prácticas para la construcción de conjuntos de datos

1. **Independence & Preventing Cheating (Data Contamination Prevention)**
   - Nunca permita que las muestras de los conjuntos de datos de evaluación se filtren en su formación de modelos o conjuntos de datos de ajuste fino.
   - Si los conjuntos de evaluación se derivan de conjuntos de datos públicos, actualizarlos o reescribirlos periódicamente (por ejemplo, intercambiar entidades, cambiar números, alterar estructuras de oraciones) para evitar que los modelos obtengan puntuaciones altas puramente a través de la memorización.

2. **Coverage & Balanced Distribution (Data Distribution)**
   - **Scenario Coverage**Si su caso de uso implica "comprensión del contenido de vídeo", su conjunto de datos de evaluación no solo debe incluir Prompts generales de texto largo, sino también casos complejos con timestamps, metadatos heterogéneos o consultas de contexto largo.
   - **Tag Balance**: Asegúrese de que la distribución de las categorías (por ejemplo, resumen, extracción, razonamiento, traducción) se ajuste a su tráfico de producción real.

3. **Building the "Golden Dataset" (Golden Dataset)**
   - Para las evaluaciones empresariales, un "dataset de oro" de alta calidad y verificado manualmente de 100 a 500 casos es mucho más valioso que 10.000 puntos de datos sintéticos no limpios.
   - Un conjunto de datos dorado permite la prueba de regresión rápida, lo que le permite ejecutar evaluaciones en minutos y detectar derivaciones de calidad al ajustar o actualizar el modelo base.

4. **Incorporating Adversarial Testing (Adversarial Testing)**
   - Introduzca muestras de 5 a 10% de adversidad en el conjunto de datos.
   - Ejemplos: entradas con errores de tipografía, contexto conflictivo o instrucciones diseñadas para inducir errores (Injecciones de prueba). Esto es crucial para evaluar la robustez del modelo y los límites de seguridad.

5. **Version Control (Versioning)**
   - Los conjuntos de datos, como el código, deben iterarse. Implementar un control de versión claro (por ejemplo, `eval_v1.0.jsonl`¿ Qué ?`eval_v1.1_hard.jsonl`¿Qué es lo que se hace?
   - Sincronizar y actualizar el conjunto de evaluación siempre que cambie la lógica de negocios en línea o los patrones de comportamiento del usuario.

### Tamaño de muestra y confianza

50 casos de prueba no son suficientes.

Si su evaluación obtiene un puntaje del 90% en 50 casos (es decir, 45 correctos de 50), el intervalo de confianza del 95% calculado utilizando el método binomial exacto (Clopper-Pearson) es **[78%, 97%]**En este caso, el sistema de precisión real es de un 95%, con un diferencial de 19 puntos porcentuales.

En 200 casos con una precisión del 90%, el intervalo de confianza se estrecha hasta **[85%, 94%]**Ahora puedes tomar decisiones.
