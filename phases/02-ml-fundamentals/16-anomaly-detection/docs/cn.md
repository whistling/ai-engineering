...
**Type:** 构建  
**Language:** Python  
**Prerequisites:** 第2阶段，课程 01-09  
**Time:** ~75 分钟

## Learning Objectives

- 从头实现 Z-score、IQR 和 Isolation Forest 异常检测方法
- 区分点异常、上下文异常和集体异常，并为每种类型选择合适的检测方法
- 解释为什么异常检测被表述为对正常数据建模而不是对异常进行分类
- 比较无监督异常检测与有监督分类，并评估覆盖新型异常与精确率之间的权衡
